...
**Scope:** the complete local tree at `C:/Users/daijo/Documents/Business/Project MERIDIAN`, including `scaffold/backend`, `scaffold/schemas`, `scaffold/scenarios`, `scaffold/frontend`, `scaffold/docs`, and the root governance documents.
